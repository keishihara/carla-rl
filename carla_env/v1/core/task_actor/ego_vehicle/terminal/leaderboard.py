class Leaderboard:
    ...
    def get(self, timestamp):
        ...
        debug_texts = [f"cpl:{int(c_route)} dev:{int(c_route_deviation)} blo:{int(c_blocked)} t_out:{int(timeout)}"]

        terminal_debug = {"blocked": c_blocked, "route_deviation": c_route_deviation, "debug_texts": debug_texts}
