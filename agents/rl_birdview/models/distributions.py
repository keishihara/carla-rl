...
class DiagGaussianDistribution:
    def __init__(self, action_dim: int, dist_init=None, action_dependent_std=False):
        ...
        # [mu, log_std], [0, 1]
        self.acc_exploration_dist = {"go": th.FloatTensor([0.66, -3]), "stop": th.FloatTensor([-0.66, -3])}
        self.steer_exploration_dist = {"turn": th.FloatTensor([0.0, -1]), "straight": th.FloatTensor([3.0, 3.0])}
...
class BetaDistribution:
    def __init__(self, action_dim=2, dist_init=None):
        ...
        self.steer_exploration_dist = {"turn": th.FloatTensor([1.0, 1.0]), "straight": th.FloatTensor([3.0, 3.0])}
