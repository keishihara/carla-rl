...
class BasicAgent:
    ...
    def _is_vehicle_hazard(self, ev_transform, ev_id, vehicle_list):
        ...
        for target_vehicle in vehicle_list:
            ...
            if compute_yaw_difference(ego_vehicle_orientation, ori) <= 150 and is_within_distance_ahead(
                loc, ego_vehicle_location, ego_vehicle_orientation, self._proximity_threshold, degree=45
            ):
                return True
    ...
    def _is_walker_hazard(self, ev_transform, walkers_list):
        ...
        for walker in walkers_list:
            ...
            if is_within_distance_ahead(
                loc, ego_vehicle_location, ev_transform.rotation.yaw, self._proximity_threshold, degree=degree
            ):
                return True
        return False
