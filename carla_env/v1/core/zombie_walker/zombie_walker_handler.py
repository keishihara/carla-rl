...
class ZombieWalkerHandler:
    ...
    def reset(self, num_zombie_walkers, ev_spawn_locations):
        if isinstance(num_zombie_walkers, list):
        ...
        self._logger.debug(f"Spawned {len(self.zombie_walkers)} zombie walkers. Should Spawn {num_zombie_walkers}")
