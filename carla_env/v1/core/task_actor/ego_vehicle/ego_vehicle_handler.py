...
from carla_env.v1.core.task_actor.common.task_vehicle import TaskVehicle
...
class EgoVehicleHandler:
    ...
    def _build_instance(config, ego_vehicle):
        ...
        _Class = getattr(import_module("carla_env.v1.core.task_actor.ego_vehicle." + module_str), class_str)
