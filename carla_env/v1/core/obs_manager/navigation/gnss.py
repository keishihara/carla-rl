...
import carla_env.v1.core.task_actor.common.navigation.route_manipulation as gps_util
import carla_env.v1.utils.transforms as trans_utils
from carla_env.v1.core.obs_manager.obs_manager import ObsManagerBase
from carla_env.v1.core.task_actor.common.navigation.map_utils import RoadOption
...
class ObsManager(ObsManagerBase):
    ...
    def get_observation(self):
        ...
        try:
            ...
            raise Exception("gnss sensor took too long!") from None
        ...
        try:
            ...
            raise Exception("imu sensor took too long!") from None
        ...
        if (road_option_0 in [RoadOption.CHANGELANELEFT, RoadOption.CHANGELANERIGHT]) and (
    ...
    def _parse_gnss(weak_self, gnss_data):
        self = weak_self()
        data = np.array([gnss_data.latitude, gnss_data.longitude, gnss_data.altitude], dtype=np.float32)
