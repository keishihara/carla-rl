    ...
    def add(
        ...
        for i in range(self.n_envs):
            ...
            if n_steps > 0:
                ...
                self.exploration_suggests[n_start : self.pos, i] = infos[i]["terminal_debug"]["exploration_suggest"][
                    "suggest"
                ]
        ...
        for i in range(self.buffer_size):
            ...
            for j in range(self.n_envs):
                ...
                state_str = np.array2string(
                    self.observations["state"][i, j], precision=1, separator=",", suppress_small=True
                )
