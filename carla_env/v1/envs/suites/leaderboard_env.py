...
class LeaderboardEnv(CarlaEnv):
    def __init__(
        ...
        super().__init__(
            carla_map, host, port, seed, no_rendering, obs_configs, reward_configs, terminal_configs, all_tasks
        )

    @staticmethod
    def build_all_tasks(carla_map, weather_group, routes_group):
        assert carla_map in ["Town01", "Town02", "Town03", "Town04", "Town05", "Town06"]
        num_zombie_vehicles = {"Town01": 120, "Town02": 70, "Town03": 70, "Town04": 150, "Town05": 120, "Town06": 120}
        num_zombie_walkers = {"Town01": 120, "Town02": 70, "Town03": 70, "Town04": 80, "Town05": 120, "Town06": 80}
        ...
        if carla_map == "Town04" and routes_group is not None:
            description_folder = (
                CARLA_ENV_ROOT_DIR / "v1/envs/scenario_descriptions/LeaderBoard" / f"Town04_{routes_group}"
            )
        else:
            description_folder = CARLA_ENV_ROOT_DIR / "v1/envs/scenario_descriptions/LeaderBoard" / carla_map
